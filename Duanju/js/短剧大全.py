...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        result = {}
        result = {"class": [{"type_id": "32", "type_name": "生活"},
                            {"type_id": "33", "type_name": "古装"},
                            {"type_id": "34", "type_name": "穿越"},
                            {"type_id": "35", "type_name": "爱情"},
                            {"type_id": "36", "type_name": "悬疑"},
                            {"type_id": "37", "type_name": "逆袭"}
                            ],
                  }
    ...
    def detailContent(self, ids):
        ...
        res1.encoding = "utf-8"
        res = res1.text        
        content = '🧧兵哥为您介绍剧情🧧本资源来源于网络🧧侵权请联系删除💥' + self.extract_middle_text(res,'免费在线观看。','喜欢免费', 0)
